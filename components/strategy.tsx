...
export function Strategy({ state, view, onAction, onSubmit, onOpen, focus }: {
  ...
  return <>
    <div className={`policy-layout ${resources ? "resource-layout" : "rule-layout"} ${focus ? "has-selection" : ""}`}>
